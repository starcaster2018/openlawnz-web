		...
		return (
			<React.Fragment>
				...
				<p>
					...
					requires a separate license. <a href="contact">Contact us</a> for more details
				</p>

				<Header as="h3">API</Header>
				<p>
					By using our API you agree to the{" "}
					<a href="https://docs.google.com/document/d/1ozEwsJG0m_9Yw1jqSCLROFqV5YZyJ3kQF5AScpchRQs/edit?usp=sharing">
						API Terms of Use
					</a>
				</p>
				<p>
