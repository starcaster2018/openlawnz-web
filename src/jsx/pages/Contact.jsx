	...
	render() {
		return (
			<React.Fragment>
				...
				<p>
					Andrew Easterbrook: <a href="mailto:andrew@openlaw.nz">andrew@openlaw.nz</a>
				</p>

				<Header as="h3">Technology &amp; Contributing</Header>

				<p>
					Developers and designers are very welcome to contribute to the project. For more information check
					out the Github or contact William.
				</p>

				<p>
					William Parry: <a href="mailto:william@openlaw.nz">william@openlaw.nz</a>
				</p>
			</React.Fragment>
		);
	}
